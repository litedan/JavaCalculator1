...
public class ArithmeticOperation implements Operations{
    ...
    public boolean isNumber(String token, NumberSystem numberSystem) {
        try {
    ...
    private String formatResult(double value, NumberSystem numberSystem) {
        switch (numberSystem) {
            case BINARY: return Integer.toBinaryString((int)value);
            case OCTAL: return Integer.toOctalString((int)value);
            case HEXADECIMAL: return Integer.toHexString((int)value);
